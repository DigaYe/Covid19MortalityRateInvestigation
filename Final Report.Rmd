...
By comparing this result, we notice that model1, model2, model3, and model4 have the lowest AIC and BIC values. Since model1 is included in model3, and model2 is included in model4, we use below methods to find the best model.

## Backward elimination procedure

First, to compare model1 and model3, we use backward elimination procedure. 
