...
d2=data.frame(Model= c("model1", "model2", "model3", "model4", "model5", "model6","model7", "model8","model9","model10","model11","model12"), Explanatory_Variable = c("x_{ElderlyRate} + x_{Specialist} + x_{Migration} + x_{Region}","ElderlyRate + Nurse + Migration + Region", "ElderlyRate + Specialist + Migration + Unemployment_rate_2018 + Region","ElderlyRate + Nurse + Migration + Unemployment_rate_2018 + Region","ElderlyRate + Specialist + Migration + Unemployment_rate_2018 + Region + population","ElderlyRate + Nurse + Migration + Unemployment_rate_2018 + Physician_rate + Region","ElderlyRate + Specialist + Migration + Unemployment_rate_2018 + Physician_rate + Region + population","ElderlyRate + Specialist + Migration + Unemployment_rate_2018 + Physician_rate + Region + population","ElderlyRate + Nurse + Migration + Unemployment_rate_2018 + Physician_rate + Region + population","ElderlyRate + Specialist + Nurse + Migration + Unemployment_rate_2018 + Physician_rate + Region + population","ElderlyRate + Specialist + Migration + Unemployment_rate_2018 + Physician_rate + Poverty + Region + population","ElderlyRate + Specialist + Nurse + Migration + Unemployment_rate_2018 + Physician_rate + Poverty + Region + population"))
kable(d2,align = "l")
