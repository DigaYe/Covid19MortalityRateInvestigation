...
The p-values of the global F-tests for the corresponding 9 single-model fittings are listed below. Full single-model summaries are included in the appendix. 
...
By comparing this result, we notice that model1, model2, model3, and model4 have the lowest AIC and BIC values. Since model1 is nested in model3, and model2 is nested in model4, it is proper to use backward elimination procedure here. We start with a comparison between model1 and model3. 
