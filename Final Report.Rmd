...
In the previous report, we have identified 6 individually significant explanatory variables, including Specialist, Physician_rate, ElderlyRate, Region, Population, Unemployment_rate_2018. Due to the low $R_{adj}^2$ value in the models, we decided to include 3 more explanatory variables to investigate, which are Poverty, Migration, and Nurse. The 9 individual summaries are listed below.
